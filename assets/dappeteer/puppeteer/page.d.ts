import { Awaitable, Browser, ElementHandle, EvaluateFunc, Frame, Handler, NewDocumentScriptEvaluation, NodeFor, Page, WaitForOptions } from "puppeteer";
...
export declare class DPupeteerPage implements DappeteerPage<Page> {
    ...
    waitForFrame(urlOrPredicate: string | ((frame: Frame) => Awaitable<boolean>), opts?: Partial<{
        timeout: number;
    }>): Promise<Frame>;
