...
class DPupeteerPage {
    ...
    async waitForFrame(urlOrPredicate, opts) {
    ...
    async waitForXPath(xpath, opts) {
        return new elements_1.DPuppeteerElementHandle((await this.page.waitForSelector("xpath/" + xpath, opts)));
    }
